<# 
  EZ Fed Mine — One‑Click Monero P2Pool Launcher (v4)
  - Robust GitHub asset discovery (msvc/gcc win64 patterns)
  - Retries downloads; logs available assets if pattern not found
  - First run downloads XMRig, writes config.json, starts miner
  - Console persists; press ESC to close after errors or after miner exits
#>
